                                    ...
                                    <table class="table table-bordered table-striped table-condensed" id="product_table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="product_row">
                                                ...
                                                <td>
                                                    <input type="text" class="form-control quantity  quantity_{{$loop->index}}" min="{{$product->product->units->pluck('name')[0]==("piece"||"Piece"||"قطعة" || "قطعه" || "" )?1:0.00001}}" name="add_stock_lines[{{$loop->index}}][quantity]" required
