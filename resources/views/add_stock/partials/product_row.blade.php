...
@forelse ($products as $product)
    ...
    <tr class="product_row">
        ...
        <td>
            ...
            <input type="text" class="form-control quantity quantity_{{ $i }}" data-val="0"
    ...
    <tr class="row_details_{{ $i }} row_details">
        <td colspan="2"> {!! Form::label('', __('lang.batch_number'), []) !!} <br> {!! Form::text('add_stock_lines[' . $i . '][batch_number]', null, ['class' => 'form-control batchNumber']) !!}
            <button type="button" class="btn btn-success add_new_batch mt-2" id="addBatch"
                data-index="{{ $i }}" data-product="{{ $product }}" index_id="{{ $i }}">
    ...
    <tr class="hide bounce_details_td_{{ $i }} trdata">
        ...
        <td> {!! Form::label('', __('lang.manufacturing_date'), [
            'class' => 'form-label d-block mb-1 app()->isLocale("ar") ? text-end : text-start',
        ]) !!}<br>
        ...
        <td> {!! Form::label('', __('lang.expiry_date'), [
            'class' => 'form-label d-block mb-1 app()->isLocale("ar") ? text-end : text-start',
        ]) !!}<br>
        ...
        <td> {!! Form::label('', __('lang.days_before_the_expiry_date'), [
            'class' => 'form-label d-block mb-1 app()->isLocale("ar") ? text-end : text-start',
        ]) !!}<br>
        ...
        <td> {!! Form::label('', __('lang.convert_status_expire'), [
            'class' => 'form-label d-block mb-1 app()->isLocale("ar") ? text-end : text-start',
        ]) !!}<br>
