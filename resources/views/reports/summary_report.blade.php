                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        <td>@lang('lang.amount')</td>
                                        <td style="text-align: right">{{ @num_format($purchase_returns->total_amount) }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>@lang('lang.return')</td>
                                        <td style="text-align: right">{{ @num_format($purchase_returns->total_count) }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>@lang('lang.tax')</td>
                                        <td style="text-align: right">{{ @num_format($purchase_returns->total_taxes) }}
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <div class="col-md-4">
                            <table class="table">
                                ...
                                @php
                                    $net_profit_loss = $sales->total_amount - $sales->total_taxes - ($add_stocks->total_amount - $add_stocks->total_taxes) - ($sale_returns->total_amount - $sale_returns->total_taxes) + ($purchase_returns->total_amount - $purchase_returns->total_taxes);
                                @endphp
                                <tbody>
                                    <tr>
                        ...
                        <div class="col-md-3">
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        <td>@lang('lang.amount')</td>
                                        <td style="text-align: right">{{ @num_format($payment_received->total_amount) }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>@lang('lang.received')</td>
                                        <td style="text-align: right">{{ @num_format($payment_received->total_count) }}
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: right">{{ @num_format($payment_received->total_cheque) }}
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: right">{{ @num_format($payment_received->total_paypal) }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>@lang('lang.deposit')</td>
                                        <td style="text-align: right">{{ @num_format($payment_received->total_deposit) }}
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
