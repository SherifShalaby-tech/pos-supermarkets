...
@if (empty($quick_add))
    <div class="d-flex my-2  @if (app()->isLocale('ar')) justify-content-end @else justify-content-start @endif">
        <button class="text-decoration-none toggle-button mb-0" type="button" data-bs-toggle="collapse"
            data-bs-target="#importantDatesCollapse" aria-expanded="false" aria-controls="importantDatesCollapse">
    ...
    <div class="collapse" id="importantDatesCollapse">
        <div class="card mb-2">
            <div class="card-body p-2">
                <div class="col-md-12">
                    <div class="row">
                        <table class="table table-borderless" id="important_date_table" style="width: 100%;">
                            <thead>
                                <tr>
                        ...
                        <div class="col-md-12 d-flex justify-content-center">
                            <button type="button" class="add_date btn btn-main px-5 py-1">@lang('lang.add_new')</button>
                        </div>
                    </div>
                </div>
            </div>
...
<div
    ...
    <button class="text-decoration-none toggle-button mb-0" type="button" data-bs-toggle="collapse"
        data-bs-target="#referralCollapse" aria-expanded="false" aria-controls="referralCollapse">
        <i class="fas fa-arrow-down"></i>
        @lang('lang.referral')
        <span class="toggle-pill"></span>
    </button>
