                            ...
                            <div class="row">
                                ...
                                @if (session('system_mode') == 'pos' || session('system_mode') == 'garments' || session('system_mode') == 'supermarket')
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group my-group">
                                            {!! Form::select('multiple_units[]', $units, $product->multiple_units, ['class' => 'selectpicker form-control', 'data-live-search' => 'true', 'disabled' =>  false, 'style' => 'width: 80%', 'multiple', 'id' => 'multiple_units']) !!}
                                            <span class="input-group-btn">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group my-group">
                                        {!! Form::select('multiple_sizes[]', $sizes, $product->multiple_sizes, ['class' => 'selectpicker form-control', 'data-live-search' => 'true', 'disabled' => false, 'style' => 'width: 80%', 'multiple', 'id' => 'multiple_sizes']) !!}
                                        <span class="input-group-btn">
                                ...
                                @if (session('system_mode') == 'pos' || session('system_mode') == 'garments' || session('system_mode') == 'supermarket')
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group my-group">
                                            {!! Form::select('multiple_grades[]', $grades, $product->multiple_grades, ['class' => 'selectpicker form-control', 'data-live-search' => 'true', 'disabled' =>  false, 'style' => 'width: 80%', 'multiple', 'id' => 'multiple_grades']) !!}
                                            <span class="input-group-btn">
                                    ...
                                    <table class="table" id="variation_table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="supplier_div supplier_div @if (empty($product->is_service)) hide @endif">@lang('lang.purchase_price')</th>
                                                <th class="supplier_div supplier_div @if (empty($product->is_service)) hide @endif">@lang('lang.sell_price')</th>
