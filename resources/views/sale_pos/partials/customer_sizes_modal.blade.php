    ...
    <div class="modal-dialog" role="document" style="width: 75%;">
        <div class="modal-content">
            <div
                ...
                <h5 class="modal-title position-relative  d-flex align-items-center" style="gap: 5px;">@lang('lang.customer_size')
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            {!! Form::select('customer_size_id', [], !empty($transaction) ? $transaction->customer_size_id : null, [
