                                ...
                                <div class="col-6 font-responsive" style="padding: 0">
                                    ...
                                    width: 100%;">
                                        ...
                                        <select name="terms_and_condition_id" id="terms_and_condition_id"
                                            style="width: 100%" class=" selectpicker terms" data-live-search="true">
                    ...
                    <div style="width: 100%" class="d-flex col-12 col-lg-2 flex-lg-column p-0">
                        ...
                        <div class="mb-2 height-responsive" style="width: 100%">
                            ...
                            @if (session('system_mode') != 'restaurant')
                                <button data-method="paypal"
                                    style="background-color: #21912A;border: none;outline: none;box-shadow: 0 8px 6px -5px #bbb ;color: white; border-radius: 6px;width:100%;"
                                    type="button" class="height-responsive payment-btn font-responsive"
                        ...
                        <div class="mb-2 height-responsive ml-1 ml-lg-0" style="width: 100%">
                            <button data-method="pay-later"
                                style="background-color: #21912A;border: none;outline: none;box-shadow: 0 8px 6px -5px #bbb ;color: white; border-radius: 6px;width:100%;"
                                type="button" class="height-responsive font-responsive payment-btn"
                    ...
                    <div style="width: 100%" class="d-flex col-lg-2 flex-lg-column p-0">
                        ...
                        <div class="height-responsive mb-2" style="width: 100%">
                            <button
                                ...
                                type="button" class="height-responsive" id="cancel-btn"
                        ...
                        <div class="card">
                            <div class="card-body" style="padding: 0px 10px; !important">
                                ...
                                <input type="hidden" name="customer_size_id_hidden" id="customer_size_id_hidden"
                                    value="">
                                <input type="hidden" name="enable_the_table_reservation"
                                    id="enable_the_table_reservation"
                                    ...
                                    <div class="col-lg-12 main_settings">
                                                    ...
                                                    <div class="col-lg-1">
                                                        <button type="button" style="padding: 0px !important;"
                                                            ...
                                                            class="btn btn-modal pull-right mt-4"><img
                                                                src="{{ asset('images/black-table.jpg') }}"
                                                                alt="black-table"
                                        ...
                                        <div class="col-lg-12 main_settings">
                                            ...
                                            <div class="row table_room_show hide">
                                                ...
                                                <input type="hidden" name="service_fee_id_hidden"
                                                    id="service_fee_id_hidden" value="">
                                                ...
                                                <div class="col-lg-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="hidden" id="status" name="status"
                                                            value="final" />
                                                        <input type="hidden" id="total_sp_discount"
                                                            name="total_sp_discount" value="0" />
                                                        <input type="hidden" id="total_pp_discount"
                                                            name="total_pp_discount" value="0" />
                                            ...
                                            <div class="row">
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                        ...
                                                        {!! Form::text('start_date', null, ['class' => 'form-control modal-input', 'id' => 'rt_start_date']) !!}
                                                    </div>
                                                </div>
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                        ...
                                                        {!! Form::text('end_date', null, ['class' => 'form-control modal-input', 'id' => 'rt_end_date']) !!}
                                                    </div>
                                                </div>
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                        ...
                        <div id="draftTransaction" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"
                            ...
                            <div class="modal-dialog" role="document" style="width: 65%">
                                <div class="modal-content">
                                    <div
                                        class="modal-header position-relative border-0 d-flex justify-content-between align-items-center @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif">
                                        <h5 class="modal-title position-relative">@lang('lang.draft_transactions')
                                            <span class="position-absolute header-pill"></span>
                                        </h5>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                        ...
                                                        {!! Form::text('start_date', null, ['class' => 'form-control modal-input', 'id' => 'draft_start_date']) !!}
                                                    </div>
                                                </div>
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                        ...
                                                        {!! Form::text('end_date', null, ['class' => 'form-control modal-input', 'id' => 'draft_end_date']) !!}
                                                    </div>
                                                </div>
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                            ...
                            <div class="modal-dialog" role="document" style="width: 65%">
                                <div class="modal-content">
                                    <div
                                        class="modal-header position-relative border-0 d-flex justify-content-between align-items-center @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif">
                                        <h5 class="modal-title position-relative">
                                            @lang('lang.online_order_transactions')
                                            <span class="position-absolute header-pill"></span>
                                        </h5>
                                        <button type="button"
                                            class="close btn btn-danger d-flex justify-content-center align-items-center rounded-circle text-white"
                                            ...
                                            <div class="row">
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                        ...
                                                        {!! Form::text('start_date', null, ['class' => 'form-control modal-input', 'id' => 'online_order_start_date']) !!}
                                                    </div>
                                                </div>
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                        ...
                                                        {!! Form::text('end_date', null, ['class' => 'form-control modal-input', 'id' => 'online_order_end_date']) !!}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
